    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           User myuser= null;
            ...
            myuser= myuserDao.getUserbyEmailAndPassword(username, password);
            
            
             if(myuser!=null){
             
                 HttpSession s= request.getSession();
                 s.setAttribute("currentUser",myuser);
                 ...
                 HttpSession s= request.getSession();
                 Messages mgs= new Messages("Invalid email Id or Password","error", "alert-danger");
