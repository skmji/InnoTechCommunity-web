...
public class ConnectionProvider {
    ...
    static {
        // Set the database URL for Railway MySQL
        dbUrl = "jdbc:mysql://autorack.proxy.rlwy.net:59046/techblog?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC";

        // Use environment variables if set, otherwise fallback to Railway credentials
        dbUser = System.getenv("DB_USER") != null ? System.getenv("DB_USER") : "root";
        dbPassword = System.getenv("DB_PASSWORD") != null ? System.getenv("DB_PASSWORD") : "rxqrSCnmlyDFKPZHYfCXYPJSqplzaOKc";

        // Log warnings if default values are being used
        if (System.getenv("DB_USER") == null || System.getenv("DB_PASSWORD") == null) {
            System.err.println("Environment variables DB_USER and DB_PASSWORD are not set. Using Railway default credentials.");
        }
    }
